...
from scheduling.api.sync_failed_error_email_send import SyncFailedErrorEmailSend
...
urlpatterns = [
    ...
    path('api/sync_failed_error_email_send', SyncFailedErrorEmailSend.as_view()),
